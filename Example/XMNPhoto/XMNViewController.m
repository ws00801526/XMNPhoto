...
//  XMNPhoto
//
//  Created by XMFraker on 11/29/2016.
//  Copyright (c) 2016 XMFraker. All rights reserved.
//

#import "XMNViewController.h"

#import <XMNPhoto/XMNPhotoBrowser.h>
#import <XMNPhoto/XMNPhotoPicker.h>
...
@interface XMNViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
- (IBAction)handleBrowserAction:(UIButton *)sender {
    ...
    [links enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        XMNPhotoModel *model = [[XMNPhotoModel alloc] initWithImagePath:obj
                                                              thumbnail:nil];
        [photos addObject:model];
    }];
